...
const stripe = require("stripe")('sk_test_51M8hmyBxfMe73ILHdzVgDDpfpEZIULmTtZYCPQc2jhXQ9AV832kbmpQZeWScUFIbGRyWS0UNP4TlULsMNyjSqYbB00I9fj362j');
const app = express();
app.use(cors());
...
app.put('/payment', async (req, res) => {
  ...
  const soldedInAdvertised = await advertised.updateMany(productName, soldUpdate, options)
